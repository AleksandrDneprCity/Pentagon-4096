...
Примечание-1:
При включении через порт #FE37 режима "Аппаратный GigaScreen", фактически он включается с момента однократного программного переключения экранов, осуществляя их аппаратное переключение вначале каждой строки, м отключается в конце кадра.
