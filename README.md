...
#FE37 - дополнительный порт управления видеорежимами
    ...
    1)  X 0 1 X - X X 0 0       X X X X - X X X X        "Аппаратный мультикоолор" (атрибут цвета на байт)
    ...
    7)  X X X X - X X X 0       X X 1 X - X X X X        "FlashColor" - бит 7 атрибута цвета вместо мигания активирует палитру INK (кроме монохромного режима 512х192)
