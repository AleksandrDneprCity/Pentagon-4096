...
#FE37 - дополнительный порт BIOS управления видеорежимами.
        ...
        #EFF7:                  #FE37:
    0)  X 0 0 0 - X 0 0 0       X 0 0 X - X X X X        Стандартный видеорежим
    1)  X 0 1 0 - X 0 0 0       X X X X - X X X X        "Аппаратный мультиколор" (атрибут цвета на байт)
    2)  X 0 0 0 - X 0 0 1       X X 0 X - X X X X        "16 Colors" (каждый пиксель своим цветом)
    3)  X 0 0 0 - X 0 1 0       X X X 0 - I G R B        "512x192 монохромный", цвет текста задаётся битами I G R B порта #FE37
    4)  X 0 0 0 - X 0 1 0       X X X 1 - X X X X        "512x192 цветной", атрибут цвета на узкое знакоместо размером 8х8 пикселей
    5)  X 0 1 0 - X 0 1 0       X X X 1 - X X X X        "512x192 цветной мультиколорный" - атрибут цвета на узкий байт размером 8x1 пикселей
    6)  X 1 0 0 - X 0 0 0       X X X X - X X X X        "384x304" - экран без бордюра, количество пикселей без учёта строчных и кадровых гасящих импульсов
    7)  X X X 0 - X 0 X 0       X X 1 X - X X X X        "FlashColor" - бит 7 атрибута цвета вместо мигания активирует палитру INK (кроме монохромного режима 512х192 и 16 Colors)
    8)  X X X 0 - X 0 X X       X 1 X X - X X X X        "Аппаратный GigaScreen" - перекл. осн. и доп. экран каждую строку, вкл/выкл автоматически по факту программного переключения экранов
