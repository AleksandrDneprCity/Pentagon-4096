...
Версия 10.3.
Актуальные ревизии плат: Материнская плата (MainBoard) - 10.3.2. Верхняя плата (TopBoard) - 5.0.2.
...
20.9) Регистр палитры: Возможность переопределять стандартные 16 цветов на любые из палитры 4096 цветов. Палитра обеспечивает 12 битный цвет: для каждой компоненты R, G, B можно задавать любое 4-битное значение. Таким образом получается по 16 уровней для красного, зелёного и синего, что в совокупности даёт 4096 цветов и оттенков.
